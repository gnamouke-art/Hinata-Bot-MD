  ...
  const sock = Object.defineProperties(conn, {
    ...
    sendContact: {
      ...
      async value(jid, data, quoted, options) {
        ...
        const contacts = [];
        odio awesome-phonenumber por ocasionarme tantos problemas 
  ...
  const sections = [...listSections]
    ...
    getName: {
      ...
      value(jid = '', withoutContact = false) {
        ...
        return (withoutContact ? '' : v.name) || v.subject || v.vname || v.notify || v.verifiedName || '+' + jid.replace('@s.whatsapp.net', '');
      },
      enumerable: true,
    },
    loadMessage: {
